    ...
    constructor(props:Props){
        ...
        this.state={
            quotes:[
                ...
                {
                    content:'“In the spring, at the end of the day, you should smell like dirt.”',
                    author:`Margaret Atwood, Bluebeard's Egg `
                },
                {
                    content:'“...and then, I have nature and art and poetry, and if that is not enough, what is enough?”',
